...
type ManufacturerContactRequest struct {
...
func ManufacturerContactSave(data interface{}, c *gin.Context) map[string][]string {

	rules := govalidator.MapData{
		"manufacturer_id": []string{"required", "numeric", "existed:customers"},
