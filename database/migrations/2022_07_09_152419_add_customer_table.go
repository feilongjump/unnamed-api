...
func init() {
	...
	type Customer struct {
		...
		SalesmanId     uint64 `gorm:"type:bigint(0);not null;index;default:0;comment:业务员;"`
		MerchandiserId uint64 `gorm:"type:bigint(0);not null;index;default:0;comment:跟单员;"`
		Grade          int8   `gorm:"type:tinyint(2);not null;default:0;comment:客户等级;"`
